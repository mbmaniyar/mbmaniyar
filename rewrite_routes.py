#!/usr/bin/env python3
"""Completely rewrites admin/routes.py from scratch — no duplicates, no syntax errors."""
import os

path = os.path.expanduser("~/Desktop/mbmaniyar/app/admin/routes.py")

content = '''from flask import Blueprint, render_template, redirect, url_for, flash, request, jsonify
...
print("✅ admin/routes.py completely rewritten!")
